        ...
        <div className="min-h-screen bg-[#0f0f23] flex">
            ...
            <aside className="w-64 bg-[#1a1a2e] border-r border-gray-800 flex flex-col">
                ...
                <nav className="flex-1 px-4 py-2">
                    ...
                    <Link href="/team" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-purple-500/10 text-purple-400 border-l-2 border-purple-500 mb-1">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="flex-1 overflow-auto">
                ...
                <div className="p-8">
                    ...
                    <div className="flex gap-6 mb-8 border-b border-gray-800">
                        {[
                            { name: 'Active members', count: '1 users' },
                            { name: 'Pending invites', count: '0 users' }
                        ].map((tab) => (
                            <button
                                key={tab.name}
                                onClick={() => setActiveTab(tab.name)}
                                className={`pb-4 px-2 font-medium transition-colors relative ${activeTab === tab.name
                                        ? 'text-purple-400'
                    ...
                    <div className="bg-[#1a1a2e] border border-gray-800 rounded-2xl overflow-hidden">
                        {/* Table Header */}
                        <div className="grid grid-cols-4 gap-4 px-6 py-4 border-b border-gray-800 bg-[#0f0f23]">
                        ...
                        {/* Table Row */}
                        <div className="grid grid-cols-4 gap-4 px-6 py-5 items-center hover:bg-[#252540] transition-colors">
                            {/* User */}
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-white font-medium">{username} (Me)</p>
                                    <p className="text-gray-400 text-sm">tester@gmail.com</p>
                                </div>
                            </div>

                            {/* Joined */}
                            <div className="text-gray-300 text-sm">December 15, 2025</div>

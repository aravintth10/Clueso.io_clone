        ...
        <div className="min-h-screen bg-[#0f0f23] flex">
            ...
            <aside className="w-64 bg-[#1a1a2e] border-r border-gray-800 flex flex-col">
                ...
                <nav className="flex-1 px-4 py-2">
                    <Link href="/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-purple-500/10 text-purple-400 border-l-2 border-purple-500 mb-1">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="flex-1 overflow-auto">
                ...
                <header className="bg-[#1a1a2e] border-b border-gray-800 px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-white mb-1">Make something awesome</h1>
                            <p className="text-gray-400">Create stunning product videos and docs</p>
                        </div>
                        <button className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-medium py-2 px-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200">
                            Start Free Trial
                        </button>
                    </div>
                </header>
                ...
                <div className="p-8">
                    ...
                    <section className="mb-8">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-xl font-semibold text-white">Create a new video</h2>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {/* Record screen */}
                            <Link href="/recording/new" className="group bg-gradient-to-br from-purple-900/50 to-purple-800/30 hover:from-purple-800/60 hover:to-purple-700/40 border border-purple-500/20 hover:border-purple-500/40 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-purple-500/20">
                                <div className="flex flex-col items-start h-full">
                                    ...
                                    <h3 className="text-lg font-semibold text-white mb-2">Record screen</h3>
                                    <p className="text-sm text-gray-400 flex-1">Turn a screen recording into a studio-style video</p>
                                </div>
                            </Link>

                            {/* Upload a video */}
                            <div className="group bg-gradient-to-br from-pink-900/50 to-pink-800/30 hover:from-pink-800/60 hover:to-pink-700/40 border border-pink-500/20 hover:border-pink-500/40 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-pink-500/20 cursor-pointer">
                                <div className="flex flex-col items-start h-full">
                                    ...
                                    <p className="text-sm text-gray-400 flex-1">Upload a screen recording. Get a studio-style video</p>
                                </div>
                            </div>

                            {/* Upload a slide deck */}
                            <div className="group bg-gradient-to-br from-indigo-900/50 to-indigo-800/30 hover:from-indigo-800/60 hover:to-indigo-700/40 border border-indigo-500/20 hover:border-indigo-500/40 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-indigo-500/20 cursor-pointer">
                                <div className="flex flex-col items-start h-full">
                                    ...
                                    <h3 className="text-lg font-semibold text-white mb-2">Upload a slide deck</h3>
                                    <p className="text-sm text-gray-400 flex-1">Turn any PDF or PPT into a narrated video</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-8">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="px-2 py-1 bg-gradient-to-r from-pink-500 to-purple-600 rounded text-xs font-bold text-white">NEW</div>
                            <h2 className="text-xl font-semibold text-white">AI tools</h2>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-[#1a1a2e] border border-gray-800 hover:border-purple-500/40 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                                ...
                                <h3 className="text-lg font-semibold text-white mb-2">Cuts</h3>
                                <p className="text-sm text-gray-400">Break down a long video into bite-sized clips and videos</p>
                            </div>

                            <div className="bg-[#1a1a2e] border border-gray-800 hover:border-pink-500/40 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                                <div className="w-12 h-12 bg-pink-500/10 rounded-xl flex items-center justify-center mb-4">
                                    <svg className="w-6 h-6 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
                                </div>
                                <h3 className="text-lg font-semibold text-white mb-2">Auto-update</h3>
                                <p className="text-sm text-gray-400">Update content when your product changes</p>
                            </div>

                            <div className="bg-[#1a1a2e] border border-gray-800 hover:border-indigo-500/40 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                                <div className="w-12 h-12 bg-indigo-500/10 rounded-xl flex items-center justify-center mb-4">
                                    <svg className="w-6 h-6 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
                                    </svg>
                                </div>
                                <h3 className="text-lg font-semibold text-white mb-2">Translator</h3>
                                <p className="text-sm text-gray-400">Dub a video into 30+ languages</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="bg-[#1a1a2e] border border-gray-800 rounded-2xl p-8 text-center">

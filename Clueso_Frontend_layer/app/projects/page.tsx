        ...
        <div className="min-h-screen bg-[#0f0f23] flex">
            ...
            <aside className="w-64 bg-[#1a1a2e] border-r border-gray-800 flex flex-col">
                ...
                <nav className="flex-1 px-4 py-2">
                    ...
                    <Link href="/projects" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-purple-500/10 text-purple-400 border-l-2 border-purple-500 mb-1">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="flex-1 overflow-auto">
                ...
                <div className="p-8">
                    ...
                    <div className="flex gap-4 mb-8">
                        <button
                            onClick={() => setShowNewVideoModal(true)}
                            className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-medium py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 flex items-center gap-2"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                            </svg>
                        ...
                        <button className="bg-[#1a1a2e] hover:bg-[#252540] border border-gray-700 text-white font-medium py-3 px-6 rounded-xl transition-all duration-200 flex items-center gap-2">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                            </svg>
                            New Folder
                    ...
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-2">Click "New Video" to create a video</h2>
                        <p className="text-gray-400 mb-6">You can then organize your videos into folders here.</p>
                    </div>
                </div>
            </main>

            {/* New Video Modal - Same as dashboard */}
            {showNewVideoModal && (
